...
public class TelaAtualizarAluno extends javax.swing.JDialog {
    ...
    public TelaAtualizarAluno(Pessoa codPessoa) {
        initComponents();

        for(Endereco temp:alunob.listarEnderecoPessoa(codPessoa.getCodPessoa()))
        {
           tfRua.setText(temp.getRua());
           tfBairro.setText(temp.getBairro());
           tfNumCasa.setText(temp.getComplemento());
           cbxCidade.setSelectedItem(temp.getCidade());
           ftCEP.setText(temp.getCep());
           
        }
        
        for(Contato temp:alunob.listarContatoPessoa(codPessoa))
        {
           ftCelular.setText(temp.getCelular());
           tfEmail.setText(temp.getEmail());
           ftTelefone.setText(temp.getTelefone());
        ...
        for(Curso temp:cursoN.listarCurso())
        {
           cbxTelaCadastroAlunoCurso.addItem(temp.getNomeCurso());
           
        }
        
        tfNomeAluno.setText(codPessoa.getNome());
        cbxSexo.setSelectedItem(codPessoa.getSexo());
        cbxCorRaca.setSelectedItem(codPessoa.getCorRaca());
        cbxEstado.setSelectedItem(codPessoa.getUf());
        ftDataNascimento.setText(codPessoa.getDataNacimento());
        ftDataExpedicao.setText(codPessoa.getDataExpedicao());
        tfNaturalidade.setText(codPessoa.getNaturalidade());
        tfNomeMae.setText(codPessoa.getNomeMae());
        tfNomePai.setText(codPessoa.getNomePai());
        tfRG.setText(codPessoa.getRG());
        ftCPF.setText(codPessoa.getCpf());
        tfOrgaoEmissor.setText(codPessoa.getOrgaoEmissor());
    }
    ...
    private void initComponents() {
        ...
        cbxCorRaca.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Branca", "Preta", "Parda", "Amarela", "Indígena" }));
        ...
        pnFotoAlunoLayout.setVerticalGroup(
            pnFotoAlunoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnFotoAlunoLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(jButton4, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addComponent(lbFoto, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
        );
...
// aluno
        ...
        alunob.AtualizarAluno(alunoN, enderecoN, contatoN);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAtualizarAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
