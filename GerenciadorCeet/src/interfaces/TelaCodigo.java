...
public class TelaCodigo extends javax.swing.JFrame {
    ...
    String codigo = "159753";
    /**
     * Creates new form TelaCodigo
     */
    public TelaCodigo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tfCodigo = new javax.swing.JPasswordField();
        btCodigo = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setMaximumSize(new java.awt.Dimension(306, 73));
        jPanel1.setMinimumSize(new java.awt.Dimension(306, 73));
        jPanel1.setNextFocusableComponent(tfCodigo);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(tfCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)
    ...
    private void btCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCodigoActionPerformed
        ...
        {
            this.dispose();
            TelaNovoUsuario telaU = new TelaNovoUsuario(this, rootPaneCheckingEnabled, 0);
            telaU.setVisible(true);
        }else
        {
            JOptionPane.showMessageDialog(rootPane, "Codigo incorreto, Aceeso negado.", "Código Incorreto", 0);
        }
    ...
    private javax.swing.JPasswordField tfCodigo;
